...
-- Database: `bandienmay`
--
DROP DATABASE IF EXISTS `bandienmay`;
CREATE DATABASE IF NOT EXISTS `bandienmay` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `bandienmay`;
-- --------------------------------------------------------
...
(1, 'lapmorin@gmail.com', '19811c00a6b67103802c7cf6f698e2fc', 'Lapmorin');
...
CREATE TABLE `tbl_baiviet` (
  `baiviet_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `tbl_danhmuc_tin` (
  `danhmuctin_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `tbl_donhang` (
  `donhang_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `tbl_giaodich` (
  `giaodich_id` int(11) PRIMARY KEY NOT NULL,
  `sanpham_id` int(11) NOT NULL,
  `soluong` int(11) NOT NULL,
...
CREATE TABLE `tbl_giohang` (
  `giohang_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `tbl_khachhang` (
  `khachhang_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `tbl_sanpham` (
  `sanpham_id` int(11) PRIMARY KEY NOT NULL,
  ...
  `sanpham_active` int(11) NULL,
  `sanpham_hot` int(11) NULL,
...
CREATE TABLE `tbl_slider` (
  `slider_id` int(11) primary KEY NOT NULL,
